...
const CourseList: React.FC<CourseListProps> = ({
    ...
    const selectedDifficultyRating = matchingSchedule?.difficultyRating || "";
    const selectedTeachingStyle = matchingSchedule?.teachingStyle || "";
    ...
    const timeMatches = (times: any[], selectedTime: string) => {
        if (selectedTime === "Any") return true;
        return times.some((time: string) =>
            (selectedTime === "Morning" && isMorning(time)) ||
            (selectedTime === "Afternoon" && isAfternoon(time))
        );
    };
                                                            ...
                                                            <div className="w-full">
                                                                ...
                                                                ${professor.difficultyRating >= 1 && professor.difficultyRating <= 4
                                                                                    ...
                                                                                    <td className="p-3 pr-2 text-center">
                                                                                        <button onClick={(e) => updatedTogglePopup(professor.time, e)}
